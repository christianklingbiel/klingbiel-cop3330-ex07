...
public class App {
    public static void main(String[] args) {
        ...
        System.out.print("What is the length of the room in feet? "); int length = in.nextInt();
        System.out.print("What is the width of the room in feet? "); int width = in.nextInt();
        System.out.println("You entered dimensions of " + length + " feet by " + width + " feet.");
        System.out.println("The area is");
        System.out.println((length * width) + " square feet");
        System.out.println((length * width * 0.09290304) + " square meters");
